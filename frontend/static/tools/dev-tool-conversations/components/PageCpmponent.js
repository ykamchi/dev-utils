    ...
    */
    class PageComponent {
        ...
        render() {
            ...
            // Create wrapper
            const wrapper = window.conversations.utils.createDivContainer(this.container, null, 'conversations-page-wrapper');

            // Page header area
            const pageHeaderArea = window.conversations.utils.createDivContainer(wrapper, null, 'conversations-page-header-area');
            ...
            // Page control area
            this.pageControlArea = window.conversations.utils.createDivContainer(pageHeaderArea, null, 'conversations-page-control-area');
            new window.SpinnerComponent(this.pageControlArea);

            // Page buttons area
            this.pageButtonsArea = window.conversations.utils.createDivContainer(pageHeaderArea, null, 'conversations-page-buttons-area');
            new window.SpinnerComponent(this.pageButtonsArea);

            // Page content area
            this.pageContentArea = window.conversations.utils.createDivContainer(wrapper, null, 'conversations-page-content-area');
        ...
        renderPageTitleBox(container) {
            // Page title box
            const pageTitleBox = window.conversations.utils.createDivContainer(container, null, 'conversation-page-header-title-box');
            ...
            if (Array.isArray(this.fields)) {
                ...
                window.conversations.utils.createSpan(metaDiv, '', this.fields, 'conversations-page-details-subtitle-meta-bold');
            }
