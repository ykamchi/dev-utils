...
window.conversations.system_api.fetchStatusConversationTimeline = async function (container, hours_back, interval, group_name, conversation_type, instruction_type, states) {
    // Show loading spinner while fetching
